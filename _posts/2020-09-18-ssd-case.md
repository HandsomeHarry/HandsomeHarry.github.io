...
The STL file can be downloaded from [here.](https://handsomeharry.github.io/files/ssd-case-v3.stl) I refined the model after two test-prints, so the model you download should be perfect.
