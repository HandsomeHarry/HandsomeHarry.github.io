...
The STL file can be downloaded from <a href="{{ site.baseurl }}/files/ssd-case-v3.stl/"> here.</a> I refined the model after two test-prints, so the model you download should be perfect.
